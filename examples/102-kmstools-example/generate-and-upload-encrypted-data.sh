...
usage(){
    ...
    echo "Example: bash $0 privacy-computing-assets-us-east-1 arn:aws:kms:us-east-1:536704830979:key/b4c01ff4-8a9f-4ee3-b3fc-87bf852c0369 us-east-1"
}
...
aws kms encrypt --key-id "${KMS_ARN_ID}" --cli-binary-format raw-in-base64-out --plaintext "example-encrypted-text" | jq -r ".CiphertextBlob" > encrypted_data.txt
