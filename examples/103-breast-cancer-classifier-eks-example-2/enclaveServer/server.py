...
def get_plaintext(payload):
    ...
    encrypted_file = payload['encrypted_data']
    ...
    return data_key_plaintext, data_key_encrypted, file_contents_decrypted
...
def main():
    ...
    while True:
        ...
        try:
            ...
            decrypt_response, data_key_encrypted, file_contents_decrypted = get_plaintext(payload_decoded)
            ...
            c.send(encrypted_inference_result)
